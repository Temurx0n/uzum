...
const Ish = () => {
  return <div className="container cart_box">
    ...
    <div className="a2">
      <div className="cards">
        <div className="cart">
          <img src="https://olcha.uz/image/700x700/products/ukWkT3mIExbvfnd9jDQ0kzZYpwu2DTeGUyRwtJ72kYS7Z41TTzTxQ0uahyMx.jpg" alt="" className="card_img" />
          <h2 className="card_p">Robot changyutgich</h2>
